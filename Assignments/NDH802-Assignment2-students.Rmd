...
(e) What is the probability that a randomly chosen customer will be a loyal customer who only shop offline? Formally, compute $P(\text{channeltype} = \text{offlineonly}\cap \text{loyal} = 1)$. (1p)
