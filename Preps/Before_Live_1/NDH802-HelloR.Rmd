...
### Knit your document, 
For the assignments, you will submit both the RMarkdown file (so something like this), and a pdf document. First you need to install a sort of software and it's a bit complicated. We will get into that in the live session. Now, you will 
Now, click Knit (top left of the RMarkdown screen) or, press Ctrl/Cmd + Shift + K, click "Install"/"Yes" to the windows popping up.
Observe the pdf document (appreciate your hard work) then come back here (please!!!).  
