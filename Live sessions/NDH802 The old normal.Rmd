...
What we want to compute is the *blue* area. To do that in base R, one way is to compute the grey area (which is $F(b)$ in Emelie's lecture), then subtract the pink area (which is $F(a)$ in Emelie's lecture) from it.
