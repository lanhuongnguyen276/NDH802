...
```{r}
sum(df$online.trans == "0")/nrow(df)
```


(b) What is the probability that a a randomly selected customer made at least 3 online transactions?
```{r}
p = 1-sum(df$online.trans %in% c(0,1,2))/nrow(df)
```
