...
| main.store        | The format in which the customer made the most transactions in year 2021                                   |
...
(c) Compute the mean and variance of `distance.to.store` of the customers whose `main.format` is supermarket and of the customers whose `main.format` is convenient store (1p). Comment on the difference between the means of the two groups; and the variances of the two groups (1p).
...
(e) Compare and explain (with formula) the similarities/difference among $P(B)$, $P(B \cap A)$ and $P(B \mid A)$ (2p).
